...
- When relevant to the task domain, consult `agents/memory-bank/best-practices/README.md` to identify matches and include all applicable `agents/memory-bank/best-practices/*.md` files (match by `domain`/`tags` in front matter).
