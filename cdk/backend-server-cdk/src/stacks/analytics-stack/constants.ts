...
export const ANALYTICS_PROCESSOR_FUNCTION_NAME = `${STACK_PREFIX}-analytics-processor-lambda`;
export const ANALYTICS_PROCESSOR_RULE_NAME = `${STACK_PREFIX}-analytics-processor-rule`;
