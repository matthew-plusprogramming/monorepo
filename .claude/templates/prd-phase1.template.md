...
<!-- PRD Writer: Reference to auto-generated user flow sequence diagrams.
     Populated by Phase 1.6 (Diagram Generation) after the gather-criticize loop exits.
     Flow diagrams are generated from flows/*.yaml via docs-generate.mjs. -->

> **Diagram**: See `.claude/docs/structured/generated/flow-*.mmd` (generated by Phase 1.6)
...
<!-- PRD Writer: Reference to the auto-generated architecture diagram.
     This is populated by Phase 1.6 (Diagram Generation) after the gather-criticize loop exits.
     The diagram is generated from architecture.yaml via docs-generate.mjs. -->

> **Diagram**: See `.claude/docs/structured/generated/component-c4.mmd` (generated by Phase 1.6)
...
<!-- PRD Writer: For each new boundary, provide a preliminary contract stub referencing the
     appropriate contract template. These stubs flow forward into spec authoring as starting points.
     Templates are at .claude/contracts/templates/. Use yaml:contract fenced blocks.
     These are preliminary -- spec authors will refine them into complete contracts. -->
...
_template: rest-api
method: <HTTP method>
path: <preliminary endpoint path>
auth_method: <expected auth method>
context:
...
```yaml:contract
_template: event
event_name: <preliminary.event.name>
...
entity_name: <PreliminaryEntityName>
data_classification: <expected classification>
context:
...
<!-- PRD Writer: This section aggregates auto-generated visual artifacts for the PRD.
     Phase 1.6 (Diagram Generation) populates this section after the gather-criticize loop exits.
     Phase 2 enrichment (post-spec) adds ERDs, detailed sequences, and contract overviews.
     See the PRD Report template at .claude/templates/prd-report.template.md for the full two-phase format. -->

### Phase 1 Diagrams (Preliminary)

<!-- Generated by Phase 1.6 after PRD completion -->
...
### Phase 2 Diagrams (Post-Spec Enrichment)

<!-- Generated by /docs skill after spec completion -->

- **Entity-Relationship Diagram**: `.claude/docs/structured/generated/erd.mmd`
- **Detailed Sequence Diagrams**: (from spec flow definitions)
- **Contract Overview**: (from spec wire protocol contracts)
